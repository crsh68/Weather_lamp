...
String weatherDesc = "clear sky";  // OpenWeatherMap description (lowercase)
...
#include "effects_partly_cloudy.h"
...
struct WeatherModeService : Service::LightBulb {
  ...
  boolean update() override {
    weatherMode = map(modeLevel->getNewVal(), 0, 100, 0, 10);
    return true;
  }

  void loop() override {
    int expected = map(weatherMode, 0, 10, 0, 100);
...
void loop() {
  ...
  if (weatherMode == 0) {
    ...
    if      (weatherType.indexOf("Clear")   >= 0) sunny();   // clear sky
    else if (weatherDesc.indexOf("few clouds") >= 0)   sunny();   // few clouds -> sunce
    else if (weatherDesc.indexOf("scattered clouds") >= 0 ||
             weatherDesc.indexOf("broken clouds")   >= 0)   partlyCloudy(); // djelomično oblačno
    else if (weatherDesc.indexOf("overcast clouds") >= 0)   clouds();  // potpuno oblačno
    else if (weatherType.indexOf("Cloud")   >= 0) clouds();   // ostali cloud tipovi
    ...
    if (weatherMode != lastWeatherMode) {
      ...
      switch (weatherMode) {
        ...
        case 2: Serial.println("PartlyCloudy");  break;
        case 3: Serial.println("Clouds");        break;
        case 4: Serial.println("Drizzle");       break;
        case 5: Serial.println("Rain");          break;
        case 6: Serial.println("Thunderstorm");  break;
        case 7: Serial.println("Snow");          break;
        case 8: Serial.println("Fog");           break;
        case 9: Serial.println("Wind");          break;
        case 10: Serial.println("Amber");        break;
      }
      lastWeatherMode = weatherMode;
    }
    switch (weatherMode) {
      case 1:  sunny();         break;
      case 2:  partlyCloudy();  break;
      case 3:  clouds();        break;
      case 4:  drizzle();       break;
      case 5:  rain();          break;
      case 6:  thunderstorm();  break;
      case 7:  snow();          break;
      case 8:  fog();           break;
      case 9:  wind();          break;
      case 10: amberEffect();   break;
    }
  }
